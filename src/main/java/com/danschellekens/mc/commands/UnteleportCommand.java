...
public class UnteleportCommand {
  public static LiteralArgumentBuilder<ServerCommandSource> COMMAND_UNWARP = CommandManager
    .literal("unwarp")
    .executes(UnteleportCommand::execute);

  // Another alias for /unwarp. Does the exact same thing.
  public static LiteralArgumentBuilder<ServerCommandSource> COMMAND_UNVISIT = CommandManager
    .literal("unvisit")
    .executes(UnteleportCommand::execute);
